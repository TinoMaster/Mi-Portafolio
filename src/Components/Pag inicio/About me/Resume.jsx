...
export const Resume = () => {
  return (
    ...
    >
      <p className="w-full flex lg:text-lg gap-1 justify-center items-center lg:justify-start font-semibold">
      ...
      <p className="w-full lg:text-base text-justify">
        "I am a Junior Web Developer with 4 years of experience in the
      ...
      <div className="flex flex-col gap-3 ">
        <h4 className="font-semibold w-full">Languages:</h4>
